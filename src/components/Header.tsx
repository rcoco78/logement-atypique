    ...
    <div className="fixed top-0 left-0 right-0 z-50 pt-6 flex justify-center">
      <div className={`w-full max-w-full md:max-w-7xl mx-2 md:mx-auto bg-[#f8f5ff]/80 border border-border transition-all duration-200 overflow-visible ${open ? 'rounded-t-[2rem] rounded-b-none md:rounded-[2rem]' : 'rounded-[2rem]'}`}
        ...
        <header className={`px-2 md:px-4 ${open ? 'rounded-t-2xl rounded-b-none' : 'rounded-full'} md:rounded-full md:rounded-b-full bg-transparent border-none transition-all duration-200 overflow-visible`}>
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center gap-8 mx-auto">
              <Link to="/logements" className="text-foreground/80 hover:text-primary transition-colors font-medium">Explorer</Link>
              <div className="relative group">
                ...
                <div className="absolute left-0 top-full mt-2 w-48 bg-background border rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <Link to="/logements?region=paris" className="block px-4 py-2 text-sm text-foreground/80 hover:text-primary hover:bg-secondary/50">Autour de Paris</Link>
                  <Link to="/logements?region=bordeaux" className="block px-4 py-2 text-sm text-foreground/80 hover:text-primary hover:bg-secondary/50">Autour de Bordeaux</Link>
                  <Link to="/logements?region=honfleur" className="block px-4 py-2 text-sm text-foreground/80 hover:text-primary hover:bg-secondary/50">Autour de Honfleur</Link>
                  <Link to="/logements?region=lille" className="block px-4 py-2 text-sm text-foreground/80 hover:text-primary hover:bg-secondary/50">Autour de Lille</Link>
                </div>
              </div>
              <div className="relative group">
                <button className="text-foreground/80 hover:text-primary transition-colors font-medium flex items-center gap-1">
                ...
                <div className="absolute left-0 top-full mt-2 w-48 bg-background border rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <Link to="/blog" className="block px-4 py-2 text-sm text-foreground/80 hover:text-primary hover:bg-secondary/50">Blog</Link>
                  <Link to="/temoignages" className="block px-4 py-2 text-sm text-foreground/80 hover:text-primary hover:bg-secondary/50">Témoignages propriétaires</Link>
                  <Link to="/faq" className="block px-4 py-2 text-sm text-foreground/80 hover:text-primary hover:bg-secondary/50">FAQ / Comment ça marche</Link>
                </div>
              </div>
        ...
        <div className={`md:hidden overflow-hidden transition-all duration-300 bg-transparent border-none rounded-none ${open ? 'max-h-[520px] opacity-100' : 'max-h-0 opacity-0'} w-full`}>
          <Link to="/logements" className="block text-center py-5 text-lg font-medium text-foreground/90 hover:text-primary transition-colors w-full">Explorer</Link>
          <div className="border-t mx-6"></div>
          <Link to="/logements?region=paris" className="block text-center py-4 text-base font-medium text-foreground/90 hover:text-primary transition-colors w-full">Autour de Paris</Link>
          <Link to="/logements?region=bordeaux" className="block text-center py-4 text-base font-medium text-foreground/90 hover:text-primary transition-colors w-full">Autour de Bordeaux</Link>
          <Link to="/logements?region=honfleur" className="block text-center py-4 text-base font-medium text-foreground/90 hover:text-primary transition-colors w-full">Autour de Honfleur</Link>
          <Link to="/logements?region=lille" className="block text-center py-4 text-base font-medium text-foreground/90 hover:text-primary transition-colors w-full">Autour de Lille</Link>
          <div className="border-t mx-6"></div>
          ...
          <div className="border-t mx-6"></div>
          <Link to="/contact" className="block text-center py-4 text-base font-medium text-foreground/90 hover:text-primary transition-colors w-full flex items-center justify-center gap-2">
            Contact
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 50 50" fill="currentColor" className="h-4 w-4">
