...
const Contact = () => {
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center py-32 px-4">
      <h1 className="text-4xl md:text-5xl font-bold text-center mb-8">Contact</h1>
      <p className="text-xl text-center mb-8 max-w-xl">
        Vous souhaitez échanger&nbsp;? Prenons quelques minutes pour discuter sur WhatsApp.
      </p>
      <a
